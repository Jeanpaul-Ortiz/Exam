...
MixedFraction MixedFraction::add(const MixedFraction& mf2) const {
    Fraction f1 = Fraction(this->fraction.getNumerator() + (this->integer * this->fraction.getDenominator()),this->fraction.getDenominator());
    Fraction f2 = Fraction(mf2.fraction.getNumerator() + (mf2.integer * mf2.fraction.getDenominator()), mf2.fraction.getDenominator());
    if(f2.getDenominator() % f1.getDenominator() == 0 || f1.getDenominator() % f2.getDenominator() == 0){
        Fraction f3 = Fraction(f2.getNumerator()+ f1.getNumerator(), f1.getDenominator() * f2.getDenominator());
    }
    MixedFraction mf3 = MixedFraction(floor (f3.getNumerator() / f3.getDenominator()), f3.getNumerator() % f3.getDenominator(), f3.getDenominator());
    return mf3;
}
Fraction f3 = Fraction(f2.getNumerator()+ f1.getNumerator(), f1.getDenominator() * f2.getDenominator());
/**
